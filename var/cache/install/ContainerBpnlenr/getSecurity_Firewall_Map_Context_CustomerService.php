...
$c->addHandler(${($_ = isset($this->services['security.authentication.rememberme.services.simplehash.customer']) ? $this->services['security.authentication.rememberme.services.simplehash.customer'] : $this->load('getSecurity_Authentication_Rememberme_Services_Simplehash_CustomerService.php')) && false ?: '_'});

return $this->services['security.firewall.map.context.customer'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
    ...
    yield 2 => ${($_ = isset($this->services['security.authentication.listener.form.customer']) ? $this->services['security.authentication.listener.form.customer'] : $this->load('getSecurity_Authentication_Listener_Form_CustomerService.php')) && false ?: '_'};
    yield 3 => ${($_ = isset($this->services['security.authentication.listener.rememberme.customer']) ? $this->services['security.authentication.listener.rememberme.customer'] : $this->load('getSecurity_Authentication_Listener_Rememberme_CustomerService.php')) && false ?: '_'};
    yield 4 => ${($_ = isset($this->services['security.authentication.listener.anonymous.customer']) ? $this->services['security.authentication.listener.anonymous.customer'] : $this->load('getSecurity_Authentication_Listener_Anonymous_CustomerService.php')) && false ?: '_'};
