...
include_once $this->targetDirs[3].'\\src\\Eccube\\Command\\PluginUninstallCommand.php';

$this->services['Eccube\Command\PluginUninstallCommand'] = $instance = new \Eccube\Command\PluginUninstallCommand();
...
$instance->setPluginRepository(${($_ = isset($this->services['Eccube\Repository\PluginRepository']) ? $this->services['Eccube\Repository\PluginRepository'] : $this->getPluginRepositoryService()) && false ?: '_'});
