...
// Returns the private 'eccube.purchase.flow.shopping.holder_post_validators' shared service.
...
include_once $this->targetDirs[3].'\\src\\Eccube\\Service\\PurchaseFlow\\Processor\\PaymentChargeChangeValidator.php';
include_once $this->targetDirs[3].'\\src\\Eccube\\Service\\PurchaseFlow\\Processor\\DeliveryFeeChangeValidator.php';
include_once $this->targetDirs[3].'\\src\\Eccube\\Service\\PurchaseFlow\\Processor\\PaymentTotalNegativeValidator.php';

return $this->services['eccube.purchase.flow.shopping.holder_post_validators'] = new \Doctrine\Common\Collections\ArrayCollection([0 => ${($_ = isset($this->services['Eccube\Service\PurchaseFlow\Processor\AddPointProcessor']) ? $this->services['Eccube\Service\PurchaseFlow\Processor\AddPointProcessor'] : $this->load('getAddPointProcessorService.php')) && false ?: '_'}, 1 => ${($_ = isset($this->services['Eccube\Service\PurchaseFlow\Processor\PaymentTotalLimitValidator']) ? $this->services['Eccube\Service\PurchaseFlow\Processor\PaymentTotalLimitValidator'] : $this->load('getPaymentTotalLimitValidatorService.php')) && false ?: '_'}, 2 => ${($_ = isset($this->services['Eccube\Service\PurchaseFlow\Processor\PaymentTotalNegativeValidator']) ? $this->services['Eccube\Service\PurchaseFlow\Processor\PaymentTotalNegativeValidator'] : ($this->services['Eccube\Service\PurchaseFlow\Processor\PaymentTotalNegativeValidator'] = new \Eccube\Service\PurchaseFlow\Processor\PaymentTotalNegativeValidator())) && false ?: '_'}, 3 => new \Eccube\Service\PurchaseFlow\Processor\PaymentChargeChangeValidator(), 4 => new \Eccube\Service\PurchaseFlow\Processor\DeliveryFeeChangeValidator()]);
